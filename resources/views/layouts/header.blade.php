        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="navbar-nav ml-3">
                ...
                <li class="nav-item ml-2">
                    <a class="nav-link" href="{{URL::to('/thue-xe')}}">Thuê xe</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                @auth
                    ...
                    @can('is_admin')
                        <li class="nav-item mr-2">
                            <a class="nav-link" href="{{URL::to('/admin/thong-ke')}}">Quản trị</a>
                        </li>
                    @endcan

                    <li class="nav-item mr-2">
                        <a class="nav-link" href="{{URL::to('/trang-ca-nhan')}}">{{ auth()->user()->ho_ten }}</a>
                    </li>
                    <li class="nav-item ml-2">
                ...
                @guest
                    <li class="nav-item mr-2">
                        <a class="nav-link" href="{{URL::to('/dang-nhap')}}">Đăng nhập</a>
                    </li>
                    <li class="nav-item ml-2">
                        <a class="nav-link" href="{{URL::to('/dang-ky')}}">Đăng ký</a>
                    </li>
                @endguest
            </ul>
        </div>
